---
title: "3.x Asyncronous download using the rgbif package"
...
first find a species key using the name_suggest function and create a polygon for spatial filtering (for convenience, we do this step outside the request for download key). Secondly, we create the quiery and request the download key.
