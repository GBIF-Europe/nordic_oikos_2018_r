---
title: "Linking GBIF and environment layers (Nordic Oikos 2018)"
...
```
![GADM Norway](demo_data/gadm_norway.png "GADM admin borders for Norway")
***
...
write.table(sp_m_bio, file="./demo_data/sp_m_bio.txt", sep="\t", row.names=FALSE, col.names=TRUE, qmethod="double")
#sp_m_bio <- read.delim("./demo_data/sp_m_bio.txt", header=TRUE, dec=".", stringsAsFactors=FALSE) ## dataframe
```
